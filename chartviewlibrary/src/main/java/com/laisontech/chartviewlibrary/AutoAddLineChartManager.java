...
public class AutoAddLineChartManager {
    ...
    //一条曲线
    public AutoAddLineChartManager(LineChart mLineChart, String name, int color) {
    ...
    //多条曲线
    public AutoAddLineChartManager(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
